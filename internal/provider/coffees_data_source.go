...
// coffeesDatasource is the datasource implementation.
type coffeesDataSource struct {
	// The client reference allows it to access the provider client.
	client *hashicups.Client
}

// coffeesDataSourceModel maps data source schema data.
...
func (d *coffeesDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// Datasource attributes are what get defined in the terraform template
...
func (d *coffeesDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	...
	if !ok {
		resp.Diagnostics.AddError(
			...
			fmt.Sprintf("Expected *hashicups.Client, got: %T. Please report this issue to the provider maintainer.", req.ProviderData),
		)
